...
void FnGiveNamedItem(CPlayer_ItemServices* pItemServices, const char* pszItemName, const char* pszWeaponName, const char* pszAmmoName, const char* pszAmmo2Name, const char* pszAddonName)
{
